...
#This takes responses.csv which is the csv generated from the getUserInfo.py file and puts it in a dataframe to make life easier for data manipulation and merging
responsesDataframe = pd.read_csv('responses.csv')
#print(responsesDataframe)

#This takes in our own csv that we generated by exporting our target grouper group. The csv only has two columns usernames(shortIDs) mapped to it's matching email address
externalInfoDataframe = pd.read_csv('usersWhoNeedDuoUpdate.csv')
